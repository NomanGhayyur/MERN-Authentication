            ...
            <div className="col-md-4">
              <div className="card p-3">
                <div className="card-body text-center">
                  ...
                  <h5 className="card-title mb-3 fs-bold">
                    Highly Customizable
                  </h5>
            ...
            <div className="col-md-4">
              <div className="card p-3">
                <div className="card-body text-center">
                  ...
                  <h5 className="card-title mb-3 fs-bold">Fully Responsive</h5>
                  <p className="card-text lead">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
                  </p>
            ...
            <div className="col-md-4">
              <div className="card p-3">
                <div className="card-body text-center">
                  ...
                  <h5 className="card-title mb-3 fs-bold">User Experience</h5>
                  <p className="card-text lead">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
                  </p>
            ...
            <div className="col-md-4">
              <div className="card p-3">
                <div className="card-body text-center">
                  ...
                  <h5 className="card-title mb-3 fs-bold">Unique and Clean</h5>
                  <p className="card-text lead">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
                  </p>
            ...
            <div className="col-md-4">
              <div className="card p-3">
                <div className="card-body text-center">
                  ...
                  <h5 className="card-title mb-3 fs-bold">Creative Ideas</h5>
                  <p className="card-text lead">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
                  </p>
